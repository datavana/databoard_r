...
s <- sticker(
  ...
  p_y = 1.3,               # text y position
  p_color = "#4CAF50",     # text color

  # Hexagon styling
  h_fill = "white",      # hexagon fill color
  h_color = "#92D050",     # hexagon border color
  h_size = 2,
...
usethis::use_logo("data-raw/logo/logo_hex.png", geometry = "240x278", retina = TRUE)
